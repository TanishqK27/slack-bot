...
def calculate_gpu_usage_info(avg_response, sum_response, overall_response):
    ...
    overall_report = f"*LAST 4H GPU UTILISATION REPORT*\n\n"
    ...
    full_message += f"\nCheck out the full report: https://docs.google.com/spreadsheets/d/1U5e3Z4JBODZhn6t9Jv5ALx0lyMXdlb2KqBaKz8IpIwQ/edit#gid=0"
...
def main():
    ...
    data.append(["LAST 4H GPU UTILISATION REPORT"])
