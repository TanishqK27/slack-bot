...
def calculate_gpu_usage_info(avg_response, sum_response, overall_response):
    ...
    overall_report = f"*LAST INTERNAL (SM2) 24H GPU UTILISATION REPORT*\n\n"
    overall_report += "*Overview:*\n"
    overall_report += "This report shows the overall GPU utilization statistics across the SageMaker 2 cluster in the last 24 hours.\n\n"
...
def main(user_id=None):
    ...
    data.append(["LAST 24H INTERNAL (SM2) GPU UTILISATION REPORT"])
