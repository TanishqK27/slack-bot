...
def calculate_gpu_usage_info(avg_response, sum_response, overall_response):
    ...
    overall_report = f"*LAST 12H CW GPU UTILISATION REPORT *\n\n"
    ...
    full_message += f"\nWIP LINK IS WRONG DO NOT CLICK: https://docs.google.com/spreadsheets/d/197D3hpudlpARaPFfbCO_T5RhhgMqGNMjc2o6Wum5TZc/edit#gid=0"
...
def main():
    ...
    data.append(["LAST 12H CW GPU UTILISATION REPORT "])
    ...
    spreadsheet = open_and_fill_spreadsheet(data, 'Project Usage Last 12H')
    # Get the worksheet
