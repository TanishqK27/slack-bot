...
def calculate_gpu_usage_info(avg_response, sum_response, overall_response):
    ...
    overall_report = f"*LAST 24H CW GPU UTILISATION REPORT *\n\n"
    ...
    full_message += f"\nWIP LINK IS WRONG DO NOT CLICK: https://docs.google.com/spreadsheets/d/1bUeb7Vl95sdE8SP2QeheSgZfdJK3FMqyY-Pme3Gz1MI/edit?usp=sharing"
...
def main():
    ...
    data.append(["LAST 24H CW GPU UTILISATION REPORT "])
