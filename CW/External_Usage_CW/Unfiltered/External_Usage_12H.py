...
def calculate_gpu_usage_info(avg_response, sum_response, overall_response):
    ...
    overall_report = f"*LAST 12H EXTERNAL CW GPU UTILISATION REPORT *\n\n"
    ...
    full_message += f"\nWIP LINK IS WRONG DO NOT CLICK: https://docs.google.com/spreadsheets/d/1sGI2epqS6gGGi_83mHPPGAwwgDT1a5q7UEAw2RfCxow/edit#gid=0"
...
def main():
    ...
    data.append(["LAST 12H EXTERNAL CW GPU UTILISATION REPORT "])
