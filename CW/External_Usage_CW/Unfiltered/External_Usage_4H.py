...
def calculate_gpu_usage_info(avg_response, sum_response, overall_response):
    ...
    overall_report = f"*LAST 4H EXTERNAL CW GPU UTILISATION REPORT *\n\n"
    ...
    full_message += f"\nWIP LINK IS WRONG DO NOT CLICK: https://docs.google.com/spreadsheets/d/1Z-fMiaNLLIX91r_mOVlUP7ACEYwRTHogSVYIBgS0WVs/edit#gid=0"
...
def main():
    ...
    data.append(["LAST 4H EXTERNAL CW GPU UTILISATION REPORT "])
