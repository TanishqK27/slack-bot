...
def calculate_gpu_usage_info(avg_response, sum_response, overall_response):
    ...
    for result in project_info:
        ...
        modified_ovrcluster_nodes = round(modified_ovrcluster_nodes*1.413)
    ...
    overall_report = f"*LAST EXTERNAL 24H GPU UTILISATION REPORT*\n\n"
    overall_report += "*Overview:*\n"
    overall_report += "This report shows the overall GPU utilization statistics across the external cluster in the last 24 hours.\n\n"
    ...
    full_message += f"\nCheck out the full report: https://docs.google.com/spreadsheets/d/1pJ0Ycs7dP2BOzTXikoaZpnq7-Tr6nA8gPNj2z6OY_kQ/edit#gid=0"
